const Aboutus = (props) => {
    return (
        ...
        <h2> About us </h2>
      <div className="accordion my-3" id="accordionExample"    style={{backgroundColor: props.mode === "dark" ? "#374151" : "white",
              color: props.mode === "dark" ? "white" : "black",
            }} >
  <div className="accordion-item"     style={{backgroundColor: props.mode === "dark" ? "#374151" : "white",
              color: props.mode === "dark" ? "white" : "black",
            }}>
    <h2 className="accordion-header" >
      <button className="accordion-button" type="button"    style={{backgroundColor: props.mode === "dark" ? "#374151" : "white",
              color: props.mode === "dark" ? "white" : "black",
    ...
    <div id="collapseOne" className="accordion-collapse collapse show "  data-bs-parent="#accordionExample">
      <div className="accordion-body"    style={{backgroundColor: props.mode === "dark" ? "#374151" : "white",
              color: props.mode === "dark" ? "white" : "black",
            }}>
  ...
  <div className="accordion-item" style={{backgroundColor: props.mode === "dark" ? "#374151" : "white",
    ...
    <h2 className="accordion-header">
      <button className="accordion-button collapsed" style={{backgroundColor: props.mode === "dark" ? "#374151" : "white",
              color: props.mode === "dark" ? "white" : "black",
  ...
  <div className="accordion-item" style={{backgroundColor: props.mode === "dark" ? "#374151" : "white",
    ...
    <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div className="accordion-body">
        This word counter software works in any <strong>web browsers such as Chrome, Firefox, Internet Explorer, Safari, Opera.</strong> It suits to count characters in facebook, blog, books, excel document, pdf document, essays, etc.
      </div>
    </div>
  </div>
</div>
